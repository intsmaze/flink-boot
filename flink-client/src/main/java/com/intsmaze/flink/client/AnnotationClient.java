 ...
 */
public class AnnotationClient extends BaseFlink {
    ...
    public static void main(String[] args) throws Exception {
        AnnotationClient topo = new AnnotationClient();
    ...
    public String getConfigName() {
        return "topology-annotation.xml";
    }
    ...
    public void createTopology(StreamExecutionEnvironment builder) {
        ...
        DataStream<String> processDataStream = inputDataStrem.flatMap(new AnnotationFlatMap());
