...
import com.intsmaze.flink.validate.tsak.ValidateFlatMap;
 ...
 */
public class ValidateClient extends BaseFlink {
    ...
    public static void main(String[] args) throws Exception {
        ValidateClient topo = new ValidateClient();
    ...
    public void createTopology(StreamExecutionEnvironment builder) {
        ...
        DataStream<String> processDataStream = inputDataStrem.flatMap(new ValidateFlatMap());

        processDataStream.print("校验后的数据");
    }
