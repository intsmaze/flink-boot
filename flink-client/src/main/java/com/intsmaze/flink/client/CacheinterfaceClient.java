 ...
 */
public class CacheinterfaceClient extends BaseFlink {
    ...
    public static void main(String[] args) throws Exception {
        CacheinterfaceClient topo = new CacheinterfaceClient();
    ...
    public void createTopology(StreamExecutionEnvironment builder) {
        ...
        DataStream<String> processDataStream = inputDataStrem.flatMap(new CacheFlatMap());
